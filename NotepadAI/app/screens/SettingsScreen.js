...
export default function SettingsScreen(props) {
  ...
  const displayDeleteAlert = () => {
    Alert.alert(
      "Вы уверены?",
      "Это пермаментно удалит все данные!",
      [
        {
          text: "Удалить",
          onPress: deleteData,
  ...
  useEffect(() => {
    theme === "light"
      ? setAvatarColor(colors.LIGHT_TIME)
      : setAvatarColor(colors.DARK);
  }, [theme]);
    ...
    <>
      ...
      >
        ...
        <View style={styles.nameBlock}>
          ...
          <TouchableOpacity
            style={[styles.changeNameBtn, { borderColor: colors.PURPLE }]} onPress={() => {setChangeUserModalVisible(true)}}
          >
            <IconView
              IconName="pencil-alt"
              type="FontAwesome5"
            ...
            />
            <Text style={[styles.changeNameText, { color: colors.PURPLE }]}>
              Изменить имя
            </Text>
          </TouchableOpacity>
        </View>
        <View style={styles.settingsBlock}>
            ...
            <TouchableOpacity style={styles.funcBtn} onPress={() => {navigation.navigate('APIKeysScreen')}}>
              <View style={styles.funcBlock}>
                <IconView
                  ...
                  theme={theme}
                />
                <Text style={[styles.funcText, { color: textColor }]}>
                  Change API Keys
                </Text>
              </View>
              <IconView
          ...
          <View style={styles.changeThemeBtn}>
            <TouchableOpacity
              ...
              onPress={() => {
                setThemeChooseModalVisible(true);
              }}
            >
              <View style={styles.funcBlock}>
                <IconView
              ...
              <Text style={[styles.currTheme, { color: textColor }]}>
        ...
        <View style={styles.deleteDataBtn}>
          <TouchableOpacity onPress={displayDeleteAlert}>
            <View style={styles.funcBlock}>
              ...
              />
              <Text style={[styles.funcText, { color: colors.RED }]}>
                Стереть все данные
              </Text>
            </View>
          </TouchableOpacity>
      ...
      <ThemeChooseModal
        visible={themeChooseModalVisible}
        onClose={() => {
          setThemeChooseModalVisible(false);
        }}
      />
      <ChangeUserModal visible={changeUserModalVisible} onClose={() => {setChangeUserModalVisible(false)}} onConfirm={handleSaveUser}/>
    </>
  );
}
